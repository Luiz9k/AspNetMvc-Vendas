...
namespace Vendas.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d5 = new Department(5, "Hentai");

            //Departament d6 = new Departament { Id = 1, Name = "Luiz" };


            Seller s1 = new Seller(1, "Ragnar Lodbrock", "ragnar@gmail.com", new DateTime(1700, 5, 18), 1500.0, d1);
            Seller s2 = new Seller(2, "Bjorn Ironside", "bjorn@gmail.com", new DateTime(1730, 10, 31), 3500.0, d2);
            Seller s3 = new Seller(3, "Lagerta QueenShield", "lagerta@gmail.com", new DateTime(1705, 9, 4), 1500.0, d5);
            Seller s4 = new Seller(4, "Meridith Grey", "meredith@gmail.com", new DateTime(1985, 11, 30), 3000.0, d4);
            Seller s5 = new Seller(5, "Derek Shepherd", "derek@gmail.com", new DateTime(1980, 1, 9), 4000.0, d5);
            Seller s6 = new Seller(6, "Christine Young", "christine@gmail.com", new DateTime(1986, 3, 4), 3000.0, d3);
            ...
            SalesRecord r3 = new SalesRecord(3, new DateTime(2018, 09, 13), 4000.0, SalesStatus.Billed, s4);
            ...
            SalesRecord r9 = new SalesRecord(9, new DateTime(2018, 09, 14), 11000.0, SalesStatus.Billed, s6);
            ...
            SalesRecord r12 = new SalesRecord(12, new DateTime(2018, 09, 25), 7000.0, SalesStatus.Billed, s3);
            ...
            SalesRecord r23 = new SalesRecord(23, new DateTime(2018, 10, 19), 11000.0, SalesStatus.Billed, s2);
            ...
            SalesRecord r27 = new SalesRecord(27, new DateTime(2018, 10, 13), 9000.0, SalesStatus.Billed, s1);
